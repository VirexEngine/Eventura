/**
 * DataContext — Global reactive state store.
 * Wraps all mutable data (teams, scores, notifications) so components
 * can read and update it without prop-drilling.
 */
...
// ── Certificate template settings type ────────────────────────────────────────
...
export function DataProvider({ children }: { children: React.ReactNode }) {
  ...
  // Load team data from backend on mount (merge into mock data)
  useEffect(() => {
    mockTeams.forEach(t => {
