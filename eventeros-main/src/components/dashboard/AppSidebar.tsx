...
import {
  ...
  Trophy as TrophyIcon, Megaphone, Award, Globe, ChevronLeft, ChevronRight, PlusCircle
} from 'lucide-react';
...
function useOrganizerNav(): NavItem[] {
  ...
  return [
    ...
    { title: 'Create Event',  url: '/events/new',   icon: PlusCircle },
...
function useUserNav(): NavItem[] {
  const { unreadCount } = useAnnouncements();
  return [
    { title: 'Dashboard',       url: '/dashboard',      icon: LayoutDashboard },
    { title: 'My Events',       url: '/events',         icon: Calendar },
    { title: 'My Projects',     url: '/my-projects',    icon: Upload },
    { title: 'Announcements',   url: '/announcements',  icon: Megaphone, badge: unreadCount || undefined },
    { title: 'Leaderboard',     url: '/leaderboard',    icon: Trophy },
    { title: 'Certificates',    url: '/certificates',   icon: Award },
    { title: 'Public View',     url: '/public',         icon: Globe },
        ...
        <div className={cn(
          ...
          {onMobileClose && (
            <Button
              ...
              className="lg:hidden text-sidebar-foreground/50 hover:text-primary"
            >
              <X className="h-5 w-5" />
            </Button>
          )}
