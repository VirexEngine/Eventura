...
import { Eye, EyeOff, Shield, Fingerprint, ArrowLeft, Upload } from "lucide-react";
...
export const LoginModal = ({ open, onOpenChange }: LoginModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        // Store college ID in localStorage for dashboard access
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                {isRegistering ? 'Sign up to join EventOS' : 'Enter your credentials to access the portal'}
              </p>
            </div>
          </div>
        </DialogHeader>
        ...
        {!isRegistering ? (
          ...
          <form onSubmit={handleRegister} className="space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="w-20 h-20 rounded-lg bg-secondary/50 flex items-center justify-center border-2 border-dashed border-primary/50">
            ...
            {/* Team & Security */}
            <div className="space-y-3 border-t pt-4">
              <h3 className="text-sm font-semibold">Team & Security</h3>
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="teamName"
                  type="text"
                  placeholder="e.g. Phoenix Coders"
                  value={teamName}
            ...
            <div className="flex gap-2 pt-4 border-t">
              ...
              <Button type="submit" className="flex-1 bg-gradient-to-r from-primary to-cyan-500">
                Create Account →
              </Button>
            </div>
          </form>
